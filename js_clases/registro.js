function registrarse()
{
    if(document.getElementById("nombres").value!="" && document.getElementById("apellidos").value!="" && document.getElementById("cedula").value!=""
      && document.getElementById("usuario").value!="" && document.getElementById("email").value!="" && document.getElementById("fechaNacimiento").value!="" && document.getElementById("contrasenia8").value!=""){ 
